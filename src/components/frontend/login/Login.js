                    ...
                    <div className="col-lg-6 col-md-6 Login_Page_left_part">
                        ...
                        <div className="row left_part_wrapper">
                            <div className="logo_wrapper text-center">
                                <img className="img-fluid" src="assets/frontend/images/login_page_images/Logo.png" alt="iamge" />
                            </div>
                        ...
                        <div className="container custom_for_320">
                            <div className="row right_part_wrapper ">
                                <div className="first_eclips_img">
                                    <img className="img-fluid" src="assets/frontend/images/login_page_images/Ellipse 70.png" alt="iamge" />
                                </div>
                                {/* Form part start */}
                                ...
                                <div className="last_eclips_img_wrapper">
                                    <img src="assets/frontend/images/login_page_images/Ellipse 69.png" alt="iamge" />
                                </div>
