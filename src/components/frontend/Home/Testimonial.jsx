          ...
          <div className="row">
            <div className="text-center testimonial_top col-lg-12">
              <div className="testimonialHEading">
                <span className="testimonialfirstSpan">{language === 'en' ? `Testimonials` : `الشهادات - التوصيات
`}  : </span>
                <span>{language === 'en' ? `Users talking about us` : `يتحدث المستخدمون عنا
`} </span>
              </div>
            </div>
          </div>
