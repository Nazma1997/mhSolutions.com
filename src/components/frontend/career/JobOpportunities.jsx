    ...
    <div>
      <div className="banner-header section-padding valign bg-img bg-fixed img-fluid"
        data-background="https://i.ibb.co/J26y8YG/career2.jpg" style={{
          backgroundImage: `url('https://i.ibb.co/J26y8YG/career2.jpg)`, minHeight: '1000px', width: '100%', backgroundSize: '100% 100%',
      ...
      <div className="container">
        ...
        <div className="d-flex justify-content-between lg:d-flex justify-content-between px-3 py-5 job-hover" >
          ...
          <h6>Employee Type</h6>
           <h6>Full Time</h6>
           <div style={{backgroundColor:'#c6a34f', width:'100%'}} className='d-flex justify-content-evenly px-3 py-2'>
            <div>
           ...
           <BsArrowUpRight  style={{fontSize:'20px', color:'#c6a34f'}} className='mt-5 mx-3 right-hover'/>
          </div>
